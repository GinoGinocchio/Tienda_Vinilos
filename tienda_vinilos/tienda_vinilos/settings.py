"""
Django settings for tienda_vinilos project.
...
ALLOWED_HOSTS = ['ginoginocchio.pythonanywhere.com','127.0.0.1']
...
ROOT_URLCONF = 'tienda_vinilos.urls'
...
WSGI_APPLICATION = 'tienda_vinilos.wsgi.application'
